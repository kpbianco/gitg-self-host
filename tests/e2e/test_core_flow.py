...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "Mixed: Several signals and labels were compared",
            "Scope: One ordinary episode practices emotional differentiation",
            None,
            "The event is separated from its interpretation",
            "At least three nearby emotions are compared",
        ),
        (
            "07.04",
            "graduated-approach",
            "Mixed: The person completed both attempts",
            "Scope: This is an ordinary comfort-zone experiment",
            "nimh.nih.gov",
            "A worthwhile aim and testable feared prediction are written",
            "Two attempts or an explicit safety stop are recorded",
        ),
        (
            "07.09",
            "emotional-expression",
            "Mixed: The feeling was expressed clearly",
            "Scope: One bounded disclosure practices healthy expression",
            None,
            "Observation feeling and need are distinguishable",
            "The listener consents to the time and channel",
        ),
        (
            "07.13",
            "mental-health-help",
            "Mixed: The levels and contacts are complete",
            "Scope: This is support navigation",
            "nimh.nih.gov",
