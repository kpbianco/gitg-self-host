...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "Mixed: The person identified hurt",
            "Scope: Two ordinary moments exercise emotional differentiation",
            None,
            "The observable event is separated from interpretation",
            "All seven neighboring states are considered",
        ),
        (
            "07.04",
            "ordinary-anxiety",
            "Mixed: One reply was helpful and one was curt",
            "Scope: This is a bounded experiment with ordinary mild apprehension",
            "nhs.uk",
            "The step serves a chosen worthwhile purpose",
            "A suitable live attempt actually occurs",
        ),
        (
            "07.09",
            "emotional-expression",
            "Mixed: The feeling was understood but earlier notice could not always be promised",
            "Scope: One bounded disclosure practices expression and listening",
            None,
            "Event feeling need and request are all explicit",
            "The listener's availability and willingness are checked",
        ),
        (
            "07.13",
            "mental-health-help",
            "Mixed: A suitable provider was found, but cost and language access remained unknown",
            "Scope: This is literacy and support preparation",
            "nimh.nih.gov",
            "Functioning and safety guide the three case dispositions",
            "Routine urgent and emergency routes are location-specific",
        ),
    ],
)
