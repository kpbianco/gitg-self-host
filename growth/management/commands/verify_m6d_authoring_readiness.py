    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                ...
                f"runtime actions, a {summary.typed_production_protocols}-protocol "
                f"historical M6D-01 typed fixture cohort, and "
                f"{summary.score_active_protocols} score-active "
